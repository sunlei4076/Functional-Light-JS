...
读到这里，你已经学习了所有我所说的轻量级函数式编程的基础概念，在本章节中，我们将把这些概念应有到不同的情景当中，但不会有新的知识点产生了。
...
在例子中介绍的任何 FB 部分都可以通过可靠性和可预见性，让代码变得更容易理解。当你添加异步到你的项目里，那将会是困难重重。
...
<del>但是让我们更明确一点：并不是说一些操作不能当作同步行为，触发异步行为很容易。这些对这些操作的响应是协调的，每个操作都有可能改变应用程序的状态，这需要大量额外的工作。</del>
...
所以，作为作者的你最好付出一些努力，或者只是留给阅读你代码的人一个难题，去弄清楚如果A在B之前完成，项目中状态是什么，还有相反的情况呢？这是一个浮夸的问题，但以我的观点来看，这是一个漂亮有力的答案：有希望把复杂的代码变得更容易理解，作者就必须花费更多心思。
